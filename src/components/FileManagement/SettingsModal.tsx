...
const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const renderFormatSpecificSettings = () => {
    ...
    switch (selectedFormat.toLowerCase()) {
      case 'jpg':
        content = renderJpgSettings();
        break;
      case 'webp':
        content = renderWebpSettings();
        break;
      case 'bmp':
        content = renderBmpSettings();
        break;
      case 'tga':
        content = renderTgaSettings();
        break;
      case 'png':
        content = renderPngSettings();
        break;
      case 'avif':
        content = renderAvifSettings();
        break;
      default:
        content = null;
    }
