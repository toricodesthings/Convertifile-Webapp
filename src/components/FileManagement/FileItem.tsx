              ...
              <div className={fileItemStyles.conversionStatus}>
                {!conversionStatus.includes('Completed') &&
                  !conversionStatus.includes('Failed') &&
                    ...
                    <div className={fileItemStyles.loaderContainer}>
                      <div className={fileItemStyles.conversionLoader}>
                        <div className={fileItemStyles.conversionLoaderInner} />
                        <div className={fileItemStyles.conversionLoaderOrbit}>
                          <div className={fileItemStyles.conversionLoaderDot} />
                          <div className={fileItemStyles.conversionLoaderDot} />
                          <div className={fileItemStyles.conversionLoaderDot} />
                          <div className={fileItemStyles.conversionLoaderDot} />
                        </div>
